...
import com.cg.gasbooking.repositories.IUserRepository1;



@Service
public class IUserServiceImpl1 implements IUserService1 {
	@Autowired
	private IUserRepository1 uDao;
//	@Autowired
...
//	// Find User by Username
	...
	public Customer findByUsername(String username) {
		...
		Customer usr = uDao.findByUsername(username);
		if (usr == null) {
...
//	}
	...
	public boolean validateUser(String username, String password) throws UserNotFoundException {
		...
		Customer user = uDao.findByUsername(username);
